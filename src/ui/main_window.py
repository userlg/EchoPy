...
from utils import Config, CavaFilter, load_image, logger, get_resource_path
import os
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        smoother = CavaFilter(fft_size // 2, smoothing, 0.03)
    ...
    # contextMenuEvent removed by user request
    ...
    def _setup_shortcuts(self):
        ...
        fs_act.triggered.connect(
            lambda: self._toggle_fullscreen(not self.isFullScreen())
        )
    ...
    def _connect_signals(self):
        ...
        self.settings_dialog.fps_changed.connect(self._change_fps)
    ...
    def _load_config(self):
        ...
        # self.visualizer_widget has its own timer initialized in its __init__
        self.visualizer_widget.animation_timer.setInterval(1000 // fps_limit)
        self.visualizer_widget.set_show_fps(False)
    ...
    def _change_sample_rate(self, rate: int):
        ...
        QMessageBox.information(
            self,
            "Restart Required",
            "Sample rate changes will apply on next restart or device switch.",
        )
    ...
    def _change_fps(self, fps: int):
        ...
        if fps < 15:
            fps = 15
        self.visualizer_widget.animation_timer.setInterval(1000 // fps)
        self.config.set("fps_limit", fps)
    ...
    def _show_settings(self):
        ...
        self.settings_dialog.load_current_settings(
            ...
            opacity=self.config.get(
                "opacity", 0.3
            ),  # Note: Opacity isn't fully wired yet in main config but good to have
