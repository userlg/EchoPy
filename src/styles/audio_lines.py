...
class AudioLines(BaseVisualizer):
    ...
    def render(self, painter: QPainter, waveform: np.ndarray, fft_data: np.ndarray):
        ...
        # El FFT ya viene suavizado globalmente, por lo tanto reflejamos el dato crudo para la gráfica
        ...
        for layer in range(self.num_layers):
            ...
            painter.setPen(
                QPen(glow_color, self.line_width + 6, Qt.SolidLine, Qt.RoundCap)
            )
            ...
            if layer % 2 == 0:
                ...
                )  # Brillo extra en capas alternas
